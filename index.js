...
s7socket.on('connected', () => {
    ...
    // Polling read
    setInterval(() => {
        let data = s7socket.read(S7Comm.ParameterArea.DB, 1, 0, 200, false);
    }, 1000);

    // Polling read
    setInterval(() => {
        let data = s7socket.read(S7Comm.ParameterArea.DB, 3, 0, 10, false);
    }, 500);
    ...
    setInterval(() => {
        ...
        let data = s7socket.write(S7Comm.ParameterArea.DB, 3, 0, false, values);
    }, 2000);
